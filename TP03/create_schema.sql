DROP TABLE COMMANDES cascade constraints purge;
DROP TABLE EMPLOYES cascade constraints purge;
...
INSERT INTO CLIENTS (CODE_CLIENT,SOCIETE,VILLE,PAYS) 
	VALUES ('BLONP','Blondel père et fils','Strasbourg','France');

INSERT INTO CLIENTS (CODE_CLIENT,SOCIETE,VILLE,PAYS) 
	VALUES ('SPECD','Spécialités du monde','Paris','France');

SELECT * FROM CLIENTS;

INSERT INTO COMMANDES (NO_COMMANDE,CODE_CLIENT,NO_EMPLOYE,DATE_COMMANDE,DATE_ENVOI,PORT) 
	VALUES ('215319','BLONP',1,'17/01/2023','24/02/2023',87.3);

INSERT INTO COMMANDES (NO_COMMANDE,CODE_CLIENT,NO_EMPLOYE,DATE_COMMANDE,DATE_ENVOI,PORT) 
	VALUES ('216716','BLONP',2,'20/03/2023','27/04/2023',81.7);

INSERT INTO COMMANDES (NO_COMMANDE,CODE_CLIENT,NO_EMPLOYE,DATE_COMMANDE,DATE_ENVOI,PORT) 
	VALUES ('216109','SPECD',1,'22/02/2023','10/03/2023',97.1);

INSERT INTO COMMANDES (NO_COMMANDE,CODE_CLIENT,NO_EMPLOYE,DATE_COMMANDE,DATE_ENVOI,PORT) 
	VALUES ('216813','SPECD',2,'26/03/2023','08/05/2023',76.9);
...
ALTER TABLE COMMANDES
	DROP CONSTRAINT COMMANDES_UK;

ALTER TABLE COMMANDES
   DROP CONSTRAINT COMM_EMPL_FK ;

ALTER TABLE COMMANDES
   DROP CONSTRAINT COMM_CLIE_FK ;      
